...
const EN = {
  ...
  'product.review.privacy': 'Your contact details are optional and visible only to the Elite team.',
...
const AR: Record<keyof typeof EN, string> = {
  ...
  'product.review.emailPlaceholder': 'you@example.com',
  'product.review.privacy': 'بيانات التواصل اختيارية ولا يراها سوى فريق إيليت.',
