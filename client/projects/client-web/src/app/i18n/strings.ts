...
const EN = {
  ...
  'home.photo.switch': 'Switch product photo',
  'home.photo.previous': 'Show previous product photo',
  'home.photo.next': 'Show next product photo',
  'home.photo.showNamed': 'Show {name} product photo',
  'home.hero.photo.topPair.eyebrow': 'Product Story',
  'home.hero.photo.topPair.title': 'Top Grain',
  'home.hero.photo.topPair.subtitle': 'A clean overhead composition that lets the leather tone, stitching, and footbed embossing speak first.',
  'home.hero.photo.topPair.alt': 'Overhead photo of a brown leather Elite sandal pair',
  'home.hero.photo.angleSingle.eyebrow': 'Leather Detail',
  'home.hero.photo.angleSingle.title': 'Soft Volume',
  'home.hero.photo.angleSingle.subtitle': 'The scroll settles into a low angle so the strap curve, raised sole, and natural grain feel tactile.',
  'home.hero.photo.angleSingle.alt': 'Angled studio photo of a single brown leather Elite sandal',
  'home.hero.photo.sideSingle.eyebrow': 'Profile View',
  'home.hero.photo.sideSingle.title': 'Side Line',
  'home.hero.photo.sideSingle.subtitle': 'A precise side profile highlights the wedge, hand-finished edge, and relaxed slip-on shape.',
  'home.hero.photo.sideSingle.alt': 'Side profile studio photo of a brown leather Elite sandal',
  'home.hero.photo.frontPair.eyebrow': 'Matched Pair',
  'home.hero.photo.frontPair.title': 'Face Forward',
  'home.hero.photo.frontPair.subtitle': 'The front view centers the buckle detail and toe opening, keeping the pair sharp and symmetrical.',
  'home.hero.photo.frontPair.alt': 'Front studio photo of a pair of brown leather Elite sandals',
  'home.hero.photo.anglePair.eyebrow': 'Hero Finish',
  'home.hero.photo.anglePair.title': 'Paired Form',
  'home.hero.photo.anglePair.subtitle': 'A final three-quarter view brings both sandals together with a richer sense of depth and craft.',
  'home.hero.photo.anglePair.alt': 'Three-quarter studio photo of a pair of brown leather Elite sandals',
...
const AR: Record<keyof typeof EN, string> = {
  ...
  'home.photo.switch': 'تبديل صورة المنتج',
  'home.photo.previous': 'عرض صورة المنتج السابقة',
  'home.photo.next': 'عرض صورة المنتج التالية',
  'home.photo.showNamed': 'عرض صورة {name}',
  'home.hero.photo.topPair.eyebrow': 'قصة المنتج',
  'home.hero.photo.topPair.title': 'Top Grain',
  'home.hero.photo.topPair.subtitle': 'لقطة علوية نظيفة تبرز لون الجلد والخياطة ونقشة بطانة القدم أولاً.',
  'home.hero.photo.topPair.alt': 'صورة علوية لزوج صنادل Elite جلدية بنية',
  'home.hero.photo.angleSingle.eyebrow': 'تفاصيل الجلد',
  'home.hero.photo.angleSingle.title': 'Soft Volume',
  'home.hero.photo.angleSingle.subtitle': 'ينتقل التمرير إلى زاوية منخفضة لتظهر انحناءة الحزام وارتفاع النعل وحبيبات الجلد الطبيعية.',
  'home.hero.photo.angleSingle.alt': 'صورة بزاوية لصندل Elite جلدي بني مفرد',
  'home.hero.photo.sideSingle.eyebrow': 'منظر جانبي',
  'home.hero.photo.sideSingle.title': 'Side Line',
  'home.hero.photo.sideSingle.subtitle': 'منظر جانبي دقيق يوضح النعل المائل والحافة اليدوية والشكل المريح.',
  'home.hero.photo.sideSingle.alt': 'صورة جانبية لصندل Elite جلدي بني',
  'home.hero.photo.frontPair.eyebrow': 'زوج متناسق',
  'home.hero.photo.frontPair.title': 'Face Forward',
  'home.hero.photo.frontPair.subtitle': 'يركز المنظر الأمامي على تفصيلة المشبك وفتحة الأصابع بتوازن واضح.',
  'home.hero.photo.frontPair.alt': 'صورة أمامية لزوج صنادل Elite جلدية بنية',
  'home.hero.photo.anglePair.eyebrow': 'لقطة ختامية',
  'home.hero.photo.anglePair.title': 'Paired Form',
  'home.hero.photo.anglePair.subtitle': 'لقطة أخيرة بثلاثة أرباع تجمع الزوج بإحساس أعمق بالحرفة والملمس.',
  'home.hero.photo.anglePair.alt': 'صورة بثلاثة أرباع لزوج صنادل Elite جلدية بنية',
