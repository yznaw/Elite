...
const EN = {
  ...
  'home.model.showNamed': 'Show {name} 3D model',
  'home.model.chooseLeather': 'Choose leather color',
  'home.model.changeLeather': 'Change model color to {name}',
  'home.hero.brown.eyebrow': '3D Model',
  'home.hero.brown.title': 'Brown',
  'home.hero.brown.subtitle': 'A compressed Brown GLB view ready for swiping and close inspection.',
  'home.hero.brownArchive.eyebrow': '3D Model',
  'home.hero.brownArchive.title': 'Brown 2',
  'home.hero.brownArchive.subtitle': 'A compressed Brown archive view ready for swiping and close inspection.',
...
const AR: Record<keyof typeof EN, string> = {
  ...
  'home.model.showNamed': 'عرض نموذج {name} ثلاثي الأبعاد',
  'home.model.chooseLeather': 'اختر لون الجلد',
  'home.model.changeLeather': 'تغيير لون النموذج إلى {name}',
  'home.hero.brown.eyebrow': 'نموذج ثلاثي الأبعاد',
  'home.hero.brown.title': 'Brown',
  'home.hero.brown.subtitle': 'عرض مضغوط لملف Brown بصيغة GLB للتصفح والمعاينة عن قرب.',
  'home.hero.brownArchive.eyebrow': 'نموذج ثلاثي الأبعاد',
  'home.hero.brownArchive.title': 'Brown 2',
  'home.hero.brownArchive.subtitle': 'عرض مضغوط لملف Brown من الأرشيف للتصفح والمعاينة عن قرب.',
