 ...
 * agency's own fixed identity — the same on every client project, not
 * themed per-app. Only the ink color adapts, to stay legible against
 * whichever surface it sits on (the dark green sidebar vs. a light dialog).
 */
@Component({
    selector: 'ap-nous-badge',
  ...
  `,
    ...
    /* ── Sidebar placement: dark green surface, light ink, very compact ── */
    .nous-badge--sidebar {
      --nous-dark: rgba(255, 255, 255, 0.88);
      box-shadow: 0 0 0 1px rgba(95, 184, 154, 0.28);
    }
    .nous-badge--sidebar .nous-logo       { width: 22px; }
    .nous-badge--sidebar .nous-badge__sep { height: 22px; }
    .nous-badge--sidebar .nous-badge__arabic  { font-size: 8.5px; }
    .nous-badge--sidebar .nous-badge__english { font-size: 6px; letter-spacing: 1px; }
    .nous-badge--sidebar .nous-badge__copy    { font-size: 5.5px; }

    /* ── Dialog placement: light surface, real admin ink ── */
    .nous-badge--dialog {
      --nous-dark: var(--ink, #1a1f36);
    }
    .nous-badge--dialog .nous-logo       { width: 34px; }
    .nous-badge--dialog .nous-badge__sep { height: 28px; }
    .nous-badge--dialog .nous-badge__arabic  { font-size: 10px; }
    .nous-badge--dialog .nous-badge__english { font-size: 7px; }
    .nous-badge--dialog .nous-badge__copy    { font-size: 6.5px; }
  `]
})
export class NousBadgeComponent {
  @Input() placement: 'sidebar' | 'dialog' = 'dialog';
